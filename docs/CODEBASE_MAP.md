...
- `tests/test_init_local_cli.py`
- `tests/test_clone_bq_local.py`
- `tests/test_duckdb_schema.py`
...
- `tests/test_semantic_relation_*.py`
...
| Pipeline/CLI | `tests/test_cli_multi_tenant.py`, `tests/test_repo_or_exit_default.py`, 관련 `tests/test_cli_*.py` |
