    ...
    *,
    ...
    return [
        ...
        _tool(
            ...
            category="macro",
            tier="optional",
            description="List official BOK and St. Louis Fed macro research documents first, then read the original source text by source_doc_id when the document looks decision-relevant. Use it for forward-looking policy, credit, labor, productivity, housing, liquidity, and external-sector signals before they are obvious in prices or indicators.",
