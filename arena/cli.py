...
def build_parser() -> argparse.ArgumentParser:
    ...
    build_ranker = sub.add_parser("build-opportunity-ranker", help="Build learned opportunity ranker scores (regularized joint policy)")
    ...
    build_ranker.add_argument("--min-ic-dates", type=int, default=60, help="Minimum distinct labeled policy dates required")
