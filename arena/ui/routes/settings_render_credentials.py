...
var RESPONSE_EXAMPLES={
  ...
  recommend_opportunities:'{\n  "status":"ok",\n  "selection_scope":{"mode":"ranked_union","global_limit":8,"per_profile_limit":8,"loaded_rows":42},\n  "recommendations":[\n    {"ticker":"ORBS","profile":"aggressive","bucket":"momentum","recommendation_rank":1,\n     "recommendation_score":7.9087,"action":"candidate","model_confidence":"medium",\n     "reason_for":"Learned IC ranker score=+7.9087; contribs: bp(+7.0496), sentiment(+0.3831), lowvol(+0.2016)",\n     "reason_risk":"blended_oos_ic=-0.015; signals_scored=14",\n     "signal_contributions":[{"signal":"bp","contribution":7.0496},{"signal":"sentiment","contribution":0.3831}]}\n  ],\n  "by_profile":{"aggressive":[{"ticker":"ORBS","recommendation_score":7.9087}],\n    "defensive":[{"ticker":"MSFT","recommendation_score":1.2845}]}\n}',
